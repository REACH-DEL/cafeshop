  ...
  <body>
    ...
    <section id="home">
      <div class="md:grid md:px-8 pt-32 md:grid-cols-2 grid grid-cols-1 px-10">
        <div class="md:px-20 md:order-first order-last">
          ...
          <button
            class="border-solid border-2 border-light-brown bg-light-brown rounded-3xl py-3 px-8 text-white font-bold my-3 hover:bg-white hover:text-light-brown"
          >
            Buy now
          </button>
        </div>
